...
const config: Config = {
  title: 'Open Kerno Commons',
  tagline: 'Shared utilities and infrastructure for Open Kerno',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/open-kerno/commons-site/tree/main/website/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      logo: {
        alt: 'Open Kerno Logo',
        src: 'https://avatars.githubusercontent.com/u/299951247?s=400&u=960328884e3c1cb5ea6cf14446369e06c7522206&v=4',
      },
      items: [
        {
          type: 'docSidebar',
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Open Kerno. Built with Docusaurus.`,
    },
    prism: {
